...
import (
	...
	"github.com/hicqu/pebble/internal/fastrand"
...
// https://github.com/hicqu/pebble/issues/29#issuecomment-494477985
		...
		if len(mi.levels) > 1 {
			mi.ForEachLevelIter(func(li *levelIter) bool {
				...
				if f := li.iterFile; f != nil {
					...
					// at:
					// https://github.com/hicqu/pebble/pull/1041#issuecomment-763226492
					if containsKey {
